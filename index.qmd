...
<div style="display: flex; gap: 20px;">
  <img src="images/energy_histogram.png" width ="400" alt="corpus energy histogram"> 
</div>
...
<div style="display: flex; gap: 20px;"> 
  <img src="images/bleed_remaster_self_similarity.png" width="450" alt="bleed remaster ssm"> 
</div>
...
<div style="display: flex; gap: 128px;"> 
  <img src="images/intolerance_novelty_0-30.png" height="300" alt="novelty intolerance first"> 
  <img src="images/intolerance_novelty_20-50.png" height="300" alt="novelty intolerance 20-50"> 
</div>

<!-- <img src="images/intolerance_novelty_0-30.png" width="350" alt="novelty homework example"> -->


As you can see, this novelty function has a period of 21 seconds where almost no onsets are detected at all. *Intolerance* by TOOL begins with a long period of near silence before picking up at 21 seconds, which explains why the visualisation did not have any data to depict before that point. *Intolerance* is the first track to TOOL's 1993 album *Undertow*, so this near-silence was likely used in place of an intro track, which are commonly used in progressive metal albums (Dir En Grey's album *GAUZE* is a very good example of this, with *GAUZE - mode of adam* being their intro track - their outro track, *GAUZE - mode of eve* is something we'll take a closer look at in the heatmaps). 

<!-- <img src="images/intolerance_novelty_20-50.png" width="350" alt="tempo activation homework example"> -->


Here is an adjusted novelty function beginning at 20 seconds and ending at 50 seconds into the track, instead of the previous one, that covered the period of the first 30 seconds. After this, the tempo seems much more regular... at a glance. Complications arise later in the track, as the meter undergoes changes from 4/4 to 3/4 and then back again. This change in meter and tempo is very common in progressive metal, of which *Intolerance* is an early example. This track was chosen in particular because of how visible the tempo and meter changes are. It'll be easier to explain what I mean with the DFT tempogram.

### Tempo (week 11)

<div style="display: flex; gap: 20px;"> 
<img src="images/intolerance_dft.png" width="350" alt="intolerance dft">
</div>
...
<div style="display: flex; gap: 128px;"> 
  <img src="images/playlist_dendrogram_labels.png" height="250" alt="bad dendrogram"> 
  <img src="images/playlist_dendrogram_labels_small.png" height="250" alt="sample dendrogram"> 
</div>
...
<div style="display: flex; gap: 128px;"> 
  <img src="images/playlist_heatmap_labels.png" height="350" alt="bad heatmap"> 
  <img src="images/playlist_heatmap_small.png" height="350" alt="sample heatmap"> 
</div>
